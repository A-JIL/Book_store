...
<link rel="stylesheet" type="text/css" href="{{asset('assets/products.css')}}"> <div class="container mt-5 mb-5">
    <div class="container d-flex justify-content-center mt-50 mb-50">
        ...
        <div class="container py-5">
           ...
           @foreach ($pro as $p)
               @if ($p->Owner_Id != $user->id && $p->Category[0]=="O")
                 <!-- List group-->
                            ...
                            <div class="media-body order-2 order-lg-1">
                                ...
                                <div class="d-flex align-items-center justify-content-between mt-1">
                                    ...
                                    <ul class="list-inline small">
                                        ...
                                        <a href="/{{$user->id}}/buy/{{$p->id}}" ><button type="button"  class="btn btn-warning btn-lg"><i class="fa fa-cart-plus mr-2"></i> Buy this product</button></a>
